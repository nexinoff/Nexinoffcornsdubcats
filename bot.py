...
3. Распознаёт китайскую речь (whisper.cpp на телефоне или faster-whisper на сервере)
4. Переводит текст на русский (Microsoft Edge / Google / MyMemory, бесплатно)
5. Озвучивает: Fish Audio (если есть ключ), иначе Edge TTS (Microsoft), иначе gTTS
6. Склеивает результат: новое видео + новая аудиодорожка с таймингами по кускам
...
Деплой: Railway / Render / Fly.io или локально в Termux на телефоне
